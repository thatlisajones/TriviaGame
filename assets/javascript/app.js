$(document).ready(function () {
    ...
    var options = [
        {
            question: "Vine was a short-form video hosting service that allowed users to upload short, looping videos. How long could a Vine video be?", 
            choice: ["10 seconds", "7 seconds", "6 seconds", "8 seconds"],
            answer: 2,
            photo: "assets/images/vine.jpg"
         },
         {
             question: "What is 'the vine that ate the South'? It was introduced into the U.S. to control soil erosion.", 
            choice: ["Prickle Brier", "Patricia", "Leafy Spurge", "Kudzu"],
            answer: 3,
            photo: "assets/images/kudzu.jpg"
         }, 
         {
             question: "A portion of which California Interstate Highway is known as 'the Grapevine'?", 
            choice: ["405", "5", "101", "605"],
            answer: 1,
            photo: "assets/images/I5.jpg"
        }, 
        {
            question: "Marvin Gaye had a hit with 'I Heard It Through the Grapevine' in 1968. Who recorded and released the song one year earlier?", 
            choice: ["Gladys Knight & the Pips", "Creedence Clearwater Revival", "The California Raisins", "Stevie Wonder"],
            answer: 0,
            photo: "assets/images/gkpips.jpg"
        }, 
        {
            ...
            answer: 3,
            photo: "assets/images/vinvines.jpg"
        }, 
        {
            question: "Which of these regions of France is NOT known for its wine, but for its cider and calvados?", 
            choice: ["Bordeaux", "Normandy", "Languedoc", "Loire"],
            answer: 1,
            photo: "assets/images/normandy.jpg"
        }, 
        {
        ...
        }, 
        {
            ...
            answer: 3,
            photo: "assets/images/urushiol.jpg"
        }];
